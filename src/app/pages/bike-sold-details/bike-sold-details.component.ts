...
@Component({
  selector: 'app-bike-sold-details',
  templateUrl: './bike-sold-details.component.html',
  styleUrls: ['./bike-sold-details.component.scss']
})
export class BikeSoldDetailsComponent implements OnInit{
